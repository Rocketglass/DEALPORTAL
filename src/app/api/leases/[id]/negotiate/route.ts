  ...
  try {
    ...
    return NextResponse.json({
      ...
      meta: {
        ...
        baseMonthlyRent: leaseData.base_rent_monthly,
        camPercentage: leaseData.cam_percent,
        securityDeposit: leaseData.exec_security_deposit,
        parkingSpaces: leaseData.parking_spaces,
        agreedUse: leaseData.agreed_use,
        leaseTermMonths: leaseData.term_months,
