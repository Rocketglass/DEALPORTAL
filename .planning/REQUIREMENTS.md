...
- [x] **APP-01**: QR code leads to a general application page (not property-specific)
...
- [x] **APP-04**: Tenant can submit the application from within the portal
...
- [x] **LEAS-04**: Once all parties agree on lease terms, broker can generate PDF and send to DocuSign

### Notifications

- [x] **NOTF-01**: Email notification sent to all relevant parties when LOI section is updated
